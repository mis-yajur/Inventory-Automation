    ...
    <div className="space-y-6">
      ...
      {filteredUnits.length === 0 && (
        <div className="p-12 text-center text-slate-500 bg-slate-900 border border-slate-800 rounded-2xl space-y-2">
          <p className="text-sm font-semibold text-slate-300">No measurement units found.</p>
          <p className="text-xs text-slate-400">Use "Bulk Upload (CSV / Excel)" above to import measurement units, or click "+ Add Unit" to create a new entry.</p>
        </div>
      )}
